  ...
  return (
    <div className='w-1/2 py-10 px-20' >
      <form>
        ...
        <button data-aos='zoom-in' className='btn bg-[#fff7f2] text-[#360005] tracking-tight transition durstion-300 ease-in-outhover:-translate-y-2 hover:scale-120 '>Send Message</button>
        </div>
      </form>
    </div>
  )
